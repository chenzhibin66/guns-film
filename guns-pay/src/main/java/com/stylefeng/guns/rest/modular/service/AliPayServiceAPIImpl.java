...
//        log.info("DefaultAlipayServiceImpl - getOrderStatus - userId = "+userId);
    ...
    public String trade_precreate(String orderId) {
        ...
        String operatorId = "chenzhibin";

        // (必填) 商户门店编号，通过门店号和商家后台可以配置精准到门店的折扣信息，详询支付宝技术支持
        String storeId = "chenzhibin";
...
//        goodsDetailList.add(goods2);
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径 C:\Users\Administrator\Desktop\QRcode
                filePath = String.format("D:/ProgramData/ftp/qrcode/qr-%s.png",
